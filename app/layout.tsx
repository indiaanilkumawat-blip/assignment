  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Modern, professional pairing: Fraunces (display) + Inter (body). */}
        <link href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400..700;1,9..144,400..700&family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet" />
      </head>
      <body>{children}</body>
    </html>
  );
