...
const EDITABLE = ['label', 'enabled', 'order', 'tag', 'heading', 'subheading', 'marginLeft', 'marginRight', 'maxWidth', 'mediaUrl', 'mediaPublicId', 'mediaHeight', 'mediaOverlay', 'mediaPosition'] as const;
